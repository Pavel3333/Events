...
#define _Py_HashSecret (*_Py_HashSecret)


#ifdef Py_DEBUG
PyAPI_DATA(int) _Py_HashSecret_Initialized;
#define _Py_HashSecret_Initialized (*_Py_HashSecret_Initialized)
#endif
...
#define _Py_RefTotal (*_Py_RefTotal)
...
#define _Py_SwappedOp (*_Py_SwappedOp)
...
#define _PyTrash_delete_nesting (*_PyTrash_delete_nesting)

PyAPI_DATA(PyObject *) _PyTrash_delete_later;
#define _PyTrash_delete_later (*_PyTrash_delete_later)
